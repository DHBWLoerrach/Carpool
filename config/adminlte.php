...
return [
    ...
    */
    ...
    'logo' => '<b>DHBW</b> Carpool',
    'logo_img' => 'assets/img/logo.png',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'DHBW Logo',
    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'active'      => ['regex:@^dashboard@']
        ],
        [
            'text'        => 'find_driver',
            'url'         => 'drivers',
            'icon'        => 'fas fa-fw fa-car',
            'active'      => ['regex:@^drivers@']
        ],
        ...
        'Leaflet' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/customized/leaflet-routing-machine.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/leaflet-geocoder/Control.Geocoder.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/leaflet-geocoder/Control.Geocoder.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/leaflet-markercluster/leaflet.markercluster.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/leaflet-markercluster/MarkerCluster.css',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/leaflet-markercluster/MarkerCluster.Default.css',
                ]
            ],
        ],
        'DateRangePicker' => [
